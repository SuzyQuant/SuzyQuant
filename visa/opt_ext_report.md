...
To summarize, with my internship with this company as an applied scientist, I have been a key player in connecting STEM with non-profits, with polymer companies, with business startups doing transformational consulting, and actively working with locals and officials in HubZone areas such as the MOV Region.
