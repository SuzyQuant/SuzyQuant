...
From my training with Tao Learning Institute and the use of Atomic Design I've successfully edited a few startup company websites from our clients and created multiple issues and markdown-file research notes inside GitHub. Having a good website increases the chance of landing a project.
...
After helping this company I'm working with build and brand the ORBITAL<sup>TM</sup>, I went back to the Think Dojo and discussed with other managers and teams how we can be more Agile. I pointed out from observation that there was a hard time for managers and product owners figuring out what these employees were doing and what tasks and priorities are set by the managers. Then I go back to the ORBITAL concept and set up an issue for this. 

In order for projects/startups to stay in orbit they need STARs. I was a key player in the implementation of STAR (Space, Track, Assist, Reach) and Super Nova concept to reach milestones which help projects and startups orbit. Super Nova is a STAR but is a massive project, has longer timelines and has bigger impact while STARs are everyday tasks and issues that needs assistance to make tiny shifts to keep or change its track until it reach a Super Nova event or to stay in orbit.

In my projects, I worked alongside other 6 engineers and scientists and was a key player in successfully migrating visualization charts from a legacy software to AWS QuickSight by developing custom algorithms. By being curious and experimenting on tried-and-true techniques aside from testing out custom algorithms with proper research and documentations, I found out that some of the visuals need not use custom algorithms but to learn how to configure the built-in systems of AWS QuickSight to create a matching data visualization from the legacy software. 
...
I have been working with my team to develop hypotheses about the underlying causes or drivers of the trend. We have been gathering more information, created and discussed multiple directions, and has been doing agile logic changes in our Visio maps (Microsoft 365 tool)
 to reflect the company's goals and culture in the program.
